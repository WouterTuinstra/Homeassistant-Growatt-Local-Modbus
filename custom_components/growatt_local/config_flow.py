...
DEVICETYPES_OPTION = [
    ...
    selector.SelectOptionDict(value=DeviceTypes.HYBRID_120, label="RTU 2 - Hybrid v1.24"),
    selector.SelectOptionDict(value=DeviceTypes.HYBRID_120_TL_XH, label="RTU 2 - Hybrid TL-X(H) v1.24"),
