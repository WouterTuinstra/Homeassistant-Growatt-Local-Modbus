...
| 3011 | PV3 voltage | 0.1 V | `ATTR_INPUT_3_VOLTAGE` | INPUT_REGISTERS_120_TL_XH |
| 3012 | PV3 current | 0.1 A | `ATTR_INPUT_3_AMPERAGE` | INPUT_REGISTERS_120_TL_XH |
| 3013–3014 | PV3 power | 0.1 W | `ATTR_INPUT_3_POWER` | INPUT_REGISTERS_120_TL_XH |
| 3015 | PV4 voltage | 0.1 V | `ATTR_INPUT_4_VOLTAGE` | INPUT_REGISTERS_120_TL_XH |
| 3016 | PV4 current | 0.1 A | `ATTR_INPUT_4_AMPERAGE` | INPUT_REGISTERS_120_TL_XH |
| 3017–3018 | PV4 power | 0.1 W | `ATTR_INPUT_4_POWER` | INPUT_REGISTERS_120_TL_XH |
| 3019–3020 | System output power (Psys H/L) | 0.1 W | `ATTR_OUTPUT_POWER` | INPUT_REGISTERS_120_TL_XH |
| 3021–3022 | Reactive power (Qac H/L) | 0.1 Var | `ATTR_OUTPUT_REACTIVE_POWER` | INPUT_REGISTERS_120_TL_XH |
| 3023–3024 | AC output power (Pac H/L) | 0.1 W | `ATTR_OUTPUT_POWER` | INPUT_REGISTERS_120_TL_XH |
| 3025 | Grid frequency (Fac) | 0.01 Hz | `ATTR_GRID_FREQUENCY` | INPUT_REGISTERS_120_TL_XH |
| 3026 | AC1 voltage (Vac1) | 0.1 V | `ATTR_OUTPUT_1_VOLTAGE` | INPUT_REGISTERS_120_TL_XH |
| 3027 | AC1 current (Iac1) | 0.1 A | `ATTR_OUTPUT_1_AMPERAGE` | INPUT_REGISTERS_120_TL_XH |
| 3028–3029 | AC1 apparent power (Pac1 H/L) | 0.1 VA | `ATTR_OUTPUT_1_POWER` | INPUT_REGISTERS_120_TL_XH |
| 3030 | AC2 voltage (Vac2) | 0.1 V | `ATTR_OUTPUT_2_VOLTAGE` | INPUT_REGISTERS_120_TL_XH |
| 3031 | AC2 current (Iac2) | 0.1 A | `ATTR_OUTPUT_2_AMPERAGE` | INPUT_REGISTERS_120_TL_XH |
| 3032–3033 | AC2 power (Pac2 H/L) | 0.1 VA | `ATTR_OUTPUT_2_POWER` | INPUT_REGISTERS_120_TL_XH |
| 3034 | AC3 voltage (Vac3) | 0.1 V | `ATTR_OUTPUT_3_VOLTAGE` | INPUT_REGISTERS_120_TL_XH |
| 3035 | AC3 current (Iac3) | 0.1 A | `ATTR_OUTPUT_3_AMPERAGE` | INPUT_REGISTERS_120_TL_XH |
| 3036–3037 | AC3 power (Pac3 H/L) | 0.1 VA | `ATTR_OUTPUT_3_POWER` | INPUT_REGISTERS_120_TL_XH |
| 3038 | Vac_RS (line voltage) | 0.1 V | `ATTR_VAC_RS` | INPUT_REGISTERS_120_TL_XH |
| 3039 | Vac_ST (line voltage) | 0.1 V | `ATTR_VAC_ST` | INPUT_REGISTERS_120_TL_XH |
...
- `ATTR_OUTPUT_REACTIVE_POWER` → **3021** (Var), set: `INPUT_REGISTERS_120_TL_XH` *(implemented)*
